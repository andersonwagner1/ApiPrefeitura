...
/**
 * <p>Classe Java de AuthenticationHeader complex type.
 * 
...
public class AuthenticationHeader {
    ...
    @XmlElementRef(name = "Username", namespace = "Jucesp.Services.Data/01", type = JAXBElement.class, required = false)
    protected JAXBElement<String> username;
    @XmlElementRef(name = "Password", namespace = "Jucesp.Services.Data/01", type = JAXBElement.class, required = false)
