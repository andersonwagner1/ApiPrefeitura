 ...
 *       &lt;sequence>
 *         &lt;element name="Sdt_DadosCadastraisEmpresa.ProcuradorItens" type="{AGATA}Sdt_DadosCadastraisEmpresa.ProcuradorItens" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ArrayOfSdtDadosCadastraisEmpresaProcuradorItens {
	...
	public void setSdtDadosCadastraisEmpresaProcuradorItens(
			List<SdtDadosCadastraisEmpresaProcuradorItens> sdtDadosCadastraisEmpresaProcuradorItens) {
		this.sdtDadosCadastraisEmpresaProcuradorItens = sdtDadosCadastraisEmpresaProcuradorItens;
	}
