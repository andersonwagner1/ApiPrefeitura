...
/**
 * <p>Classe Java de sendEmailWithAttachments complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="sendEmailWithAttachments">
 *   &lt;complexContent>
 ...
 *         &lt;element name="attachmentsPk" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "sendEmailWithAttachments", propOrder = {
    "variables",
    "fromUserPk",
    "to",
    "cc",
...
public class SendEmailWithAttachments {
    ...
    protected List<String> attachmentsPk;
    ...
    /**
     * Gets the value of the attachmentsPk property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the attachmentsPk property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAttachmentsPk().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getAttachmentsPk() {
        if (attachmentsPk == null) {
            attachmentsPk = new ArrayList<String>();
        }
        return this.attachmentsPk;
    }
