 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="TaxasItem" type="{eAgata}SdtBoletoTaxasDiversas.TaxasItem" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class SdtBoletoTaxasDiversas {
    ...
    @XmlElement(name = "DataProcessamento", required = true, nillable = true)
    @XmlSchemaType(name = "date")
    ...
    @XmlElement(name = "Vencimento", required = true, nillable = true)
    @XmlSchemaType(name = "date")
    ...
    protected SdtBoletoTaxasDiversas.Taxas taxas;
     ...
     * @return
     *     possible object is
     *     {@link SdtBoletoTaxasDiversas.Taxas }
     *     
     */
    public SdtBoletoTaxasDiversas.Taxas getTaxas() {
        return taxas;
    }
     ...
     *     
     */
    public void setTaxas(SdtBoletoTaxasDiversas.Taxas value) {
        this.taxas = value;
    }
    ...
    public static class Taxas {
        ...
        protected List<SdtBoletoTaxasDiversasTaxasItem> taxasItem;
         ...
         * 
         */
        public List<SdtBoletoTaxasDiversasTaxasItem> getTaxasItem() {
            if (taxasItem == null) {
                taxasItem = new ArrayList<SdtBoletoTaxasDiversasTaxasItem>();
            }
