 ...
 *       &lt;sequence>
 *         &lt;element name="Sdt_dadoscadastraisempresas" type="{eAgata}Sdt_DadosCadastraisEmpresa"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "wsConsultarExistenciaDaEmpresa.ExecuteResponse")
public class WsConsultarExistenciaDaEmpresaExecuteResponse {

    @XmlElement(name = "Sdt_dadoscadastraisempresas", required = true)
    protected SdtDadosCadastraisEmpresa sdtDadoscadastraisempresas;

    /**
     * Obtém o valor da propriedade sdtDadoscadastraisempresas.
     * 
     * @return
     *     possible object is
