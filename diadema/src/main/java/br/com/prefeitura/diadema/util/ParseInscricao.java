...
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaCaracteristicaFuncionamentoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaCnaeItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaContratoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaGrupoSubgrupoAtividadeItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaRepresentanteLegalItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaServicoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.ArrayOfSdtDadosCadastraisEmpresaSocioItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresa;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaCaracteristicaFuncionamentoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaCnaeItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaContratoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaGrupoSubgrupoAtividadeItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaRepresentanteLegalItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaServicoItens;
import br.com.prefeitura.diadema.ws.abaco.hmg.enviar.SdtDadosCadastraisEmpresaSocioItens;

public class ParseInscricao {
	...
	public SdtDadosCadastraisEmpresa parseAgata(InscricaoMunicipal inscricaoMunicipal) {
	    ...
	    List<SdtDadosCadastraisEmpresaCaracteristicaFuncionamentoItens> listaCaracteristicas = new ArrayList<SdtDadosCadastraisEmpresaCaracteristicaFuncionamentoItens>();
	           ...
	           //Outros
	            ...
	            dadosCadastraisEmpresa.setCaracteristicasFuncionamento(caracteristicaFuncionamentoItens);
	           ...
	           // inscricaoMunicipal.setHoraDeFuncionamentoDomingo(item.getHoraEntradaDomingo()+ " ás " + item.getHoraSaidaDomingo());
	            ...
	            dadosCadastraisEmpresa.setSocios(socios);
	            ...
	            representantes.setSdtDadosCadastraisEmpresaRepresentanteLegalItens(representantesList);
	            dadosCadastraisEmpresa.setRepresentantesLegais(representantes);
	            ...
	            if (enquadramentoAtividadeEconomica.getNumeroContrato() != null) {
	                ...
	                dadosCadastraisEmpresa.setContratos(contratos);
	            }
	
	            atividades.setSdtDadosCadastraisEmpresaGrupoSubgrupoAtividadeItens(atividadeItensList);
	            dadosCadastraisEmpresa.setGrupoSubgrupoAtividades(atividades);
	            ...
	            servicos.setSdtDadosCadastraisEmpresaServicoItens(servicoItensList);
	            dadosCadastraisEmpresa.setServicos(servicos);
	            ...
	            for(Cnae cnae : lista) {
	                ...
	                item.setNumeroCnae(parseInt(cnae.getCodigo()));
	            ...
	            cnaes.setSdtDadosCadastraisEmpresaCnaeItens(cnaeItensList);
	            dadosCadastraisEmpresa.setCnaes(cnaes);
